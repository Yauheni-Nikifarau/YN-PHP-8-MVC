...
<div class="admin-list-item">
    ...
    <a href="/admin/?action=change&change_id=<?= $good['id']; ?>" class="admin-list-change">изменить</a>
    <a href="/admin/?action=delete&delete_id=<?= $good['id']; ?>" class="admin-list-delete">удалить</a>
</div>
<?php endforeach; ?>
